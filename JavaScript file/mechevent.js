...
var rotatingImages2 = ["mechevent7.jpg", "mechevent8.jpg", "mechevent9.jpg"]; // Add more image URLs as needed
...
var rotatingImages4 = ["mechevent10.jpg", "mechevent11.jpg", "mechevent12.jpg","mechevent13.jpg"]; // Add more image URLs as needed
var rotatingIndex4 = 0;

function rotateImage4() {
    var imageElement4 = document.getElementById("rotatingImage4");
    ...
    // Change the image source after a short delay
    setTimeout(function () {
        imageElement4.src = rotatingImages4[rotatingIndex4];
        rotatingIndex4 = (rotatingIndex4 + 1) % rotatingImages4.length;
